...
import { sampleWithRequiredData } from '../expediente.test-samples';
...
describe('Expediente Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ExpedienteComponent],
      providers: [
        {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.expedientes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to expedienteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExpedienteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExpedienteIdentifier).toHaveBeenCalledWith(entity);
